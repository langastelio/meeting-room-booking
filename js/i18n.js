...
const I18N = (() => {
  ...
  const dict = {
    en: {
      ...
      "ph.searchRooms": "Filter rooms (name, location, facility)…",
      "empty.noRoomMatch": "No rooms match your filter.",
      "btn.toggleView": "Toggle card / list view",
    ...
    pt: {
      ...
      "ph.searchRooms": "Filtrar salas (nome, local, recurso)…",
      "empty.noRoomMatch": "Nenhuma sala corresponde ao filtro.",
      "btn.toggleView": "Alternar vista cartões / lista",
